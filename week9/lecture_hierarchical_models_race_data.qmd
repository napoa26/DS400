...
## Hierarchical Models: Chapter 15
...
```{r}
ggplot(cherry_blossom_sample, aes(x = age, fill = gun)) +
  geom_density(alpha = 0.5)

ggplot(cherry_blossom_sample, aes(x = gun, fill = age)) +
  geom_density(alpha = 0.5)
```

```{r}
ggplot(data = cherry_blossom_sample, aes(age, gun, color = age)) +
                              geom_point() +
  geom_smooth()
  
ggplot(data = cherry_blossom_sample, aes(age, gun, color = gun)) +
                              geom_point() 
