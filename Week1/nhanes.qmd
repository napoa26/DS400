...
```{r}
diet_behavior <- read_xpt(here("/Users/anapoleon/Documents/DS400/data/nhanes_data/DR1TOT_J.XPT"))
blood_hg <- read_xpt(here("/Users/anapoleon/Documents/DS400/data/nhanes_data/2017-2018_Hg-Blood.XPT"))
urine_hg <- read_xpt(here("/Users/anapoleon/Documents/DS400/data/nhanes_data/2017-2018_Hg-Urine.XPT"))
diabetes <- read_xpt(here("/Users/anapoleon/Documents/DS400/data/nhanes_data/2017-2018_Diabetes.XPT"))
demographics <- read_xpt(here("/Users/anapoleon/Documents/DS400/data/nhanes_data/2017-2018_Demographics.XPT"))
```
